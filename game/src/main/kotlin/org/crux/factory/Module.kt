...
import org.crux.collection.ImmutableContext
...
interface FactoryModule<PRODUCT> {
     ...
     */
    fun read(remarks: ImmutableContext, context: ProductImmutableFactoryContext<PRODUCT>, other: PRODUCT)
     ...
     */
    fun update(remarks: ImmutableContext, updateContext: AllImmutableFactoryContext<PRODUCT>?, context: ProductImmutableFactoryContext<PRODUCT>)
     ...
     */
    fun process(remarks: ImmutableContext, context: ProductImmutableFactoryContext<PRODUCT>)
     ...
     */
    fun reflect(remarks: ImmutableContext, context: DataImmutableFactoryContext<PRODUCT>)
}